...
Accounts.emailTemplates.resetPassword.siteName = "Kipa";
Accounts.emailTemplates.resetPassword.from     = "Kipa Admin Email <admin@teamkipa.com>";

// Set a subject for the reset password email.
Accounts.emailTemplates.resetPassword.subject = function(user){
  return "Kipa Reset Your Password";
}
